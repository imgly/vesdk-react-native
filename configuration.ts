...
export interface Configuration {
  ...
  textdesign?: {
    ...
    >;
    /**
     * Defines all available colors that can be applied to the text desgin.
     * @example // Defaults to:
     * [
     *   { color: [1.00, 1.00, 1.00, 1], name: "White" },
     *   { color: [0.49, 0.49, 0.49, 1], name: "Gray" },
...
export function createDefaultConfiguration(): Configuration {
  return {
    ...
    tools: [Tool.TRIM, Tool.TRANSFORM, Tool.FILTER, Tool.ADJUSTMENT, Tool.FOCUS, Tool.STICKER, Tool.TEXT, Tool.TEXT_DESIGN, Tool.OVERLAY, Tool.FRAME, Tool.BRUSH],
    transform: {
    ...
    adjustment: {
      showResetButton: true,
      items: [AdjustmentTool.BRIGHTNESS, AdjustmentTool.CONTRAST, AdjustmentTool.SATURATION, AdjustmentTool.CLARITY, AdjustmentTool.SHADOWS, AdjustmentTool.HIGHLIGHTS, AdjustmentTool.EXPOSURE, AdjustmentTool.GAMMA, AdjustmentTool.BLACKS, AdjustmentTool.WHITES, AdjustmentTool.TEMPERATURE, AdjustmentTool.SHARPNESS],
    },
    focus: {
      items: [FocusTool.NONE, FocusTool.RADIAL, FocusTool.MIRRORED, FocusTool.LINEAR, FocusTool.GAUSSIAN],
    },
    sticker: {
      categories: [
        { identifier: "imgly_sticker_category_emoticons", items: [
    ...
    text: {
      ...
      actions: [TextAction.FONT, TextAction.COLOR, TextAction.BACKGROUND_COLOR, TextAction.ALIGNMENT],
      canvasActions: [CanvasAction.ADD, CanvasAction.DELETE, CanvasAction.BRING_TO_FRONT, CanvasAction.UNDO, CanvasAction.REDO],
      textColors: [
        { color: [1.00, 1.00, 1.00, 1], name: "White" },
        { color: [0.49, 0.49, 0.49, 1], name: "Gray" },
        { color: [0.00, 0.00, 0.00, 1], name: "Black" },
    ...
    textdesign: {
      ...
      canvasActions: [CanvasAction.ADD, CanvasAction.DELETE, CanvasAction.INVERT, CanvasAction.BRING_TO_FRONT, CanvasAction.UNDO, CanvasAction.REDO],
      colors: [
        { color: [1.00, 1.00, 1.00, 1], name: "White" },
        { color: [0.49, 0.49, 0.49, 1], name: "Gray" },
        { color: [0.00, 0.00, 0.00, 1], name: "Black" },
    ...
    overlay: {
      ...
      blendModes: [BlendMode.NORMAL, BlendMode.MULTIPLY, BlendMode.OVERLAY, BlendMode.SCREEN, BlendMode.LIGHTEN, BlendMode.SOFT_LIGHT, BlendMode.HARD_LIGHT, BlendMode.DARKEN, BlendMode.COLOR_BURN],
    },
    frame: {
      items: [
        { identifier: "imgly_frame_art_decor" },
    ...
    brush: {
      actions: [BrushAction.COLOR, BrushAction.SIZE, BrushAction.HARDNESS],
      canvasActions: [CanvasAction.DELETE, CanvasAction.BRING_TO_FRONT, CanvasAction.UNDO, CanvasAction.REDO],
      colors: [
        { color: [1.00, 1.00, 1.00, 1], name: "White" },
        { color: [0.49, 0.49, 0.49, 1], name: "Gray" },
        { color: [0.00, 0.00, 0.00, 1], name: "Black" },
    ...
    export: {
      ...
      serialization: {
        ...
        filename: null,
        embedSourceImage: false,
      },
    },
    theme: ExistingTheme.DARK,
  }
}
